...
DAYS_NO_CONNECTIVITY_MAX = 14000     # do not allow to engage after this many days
DAYS_NO_CONNECTIVITY_PROMPT = 10000  # send an offroad prompt after this many days
